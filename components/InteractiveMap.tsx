        ...
        <Svg width={MAP_W} height={MAP_H} viewBox={`0 0 ${MAP_W} ${MAP_H}`}>
          <G id="Group 1">
            ...
            <Rect
              ...
              width={48}
              height={26}
              fill={SPACE_COLORS.default.fill}
              stroke={SPACE_COLORS.default.stroke}
              strokeWidth={2}
            />
            <Rect
              id="no_se_1"
            ...
            />
            <Rect
              id="secretaria_asuntos_universitarios_2"
              x={49}
              y={975}
              width={48}
              height={34}
            ...
            />
            <Rect
              id="direccion_administracion/compras/patimonio"
              x={143}
              y={928}
              width={74}
              height={45}
            ...
            />
            <Rect
              id="direccion_administracion/contable/tesoreria"
              x={143}
              y={881}
              width={74}
              height={44}
            ...
            />
            <Rect
              id="despacho_general/mesa_entrada/informes"
              x={143}
              y={802}
              width={75}
              height={44}
            ...
            />
            <Rect
              id="direccion_servicios_generales"
              x={332}
              y={702}
              width={30}
              height={23}
            ...
            />
            <Rect
              id="area_tecnica_tic/redes/servidores"
              x={452}
              y={680}
              width={55}
              height={45}
            ...
            />
            <Rect
              id="area_tecnica_tic/desarrollo/ciberseguridad"
              x={452}
              y={584}
              width={55}
              height={93}
            ...
            />
            <Rect
              id="direccion_departamento_ciencias_basicas"
              x={452}
              y={471}
              width={84}
              height={62}
