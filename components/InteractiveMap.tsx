...
export default function InteractiveMap() {
  ...
  return (
    <View
      ...
      {...(selected ? {} : panResponder.panHandlers)} // desactiva pan cuando hay sheet
    >
      <Animated.View
        collapsable={false}
      ...
      >
        ...
        <Svg width={MAP_W} height={MAP_H} viewBox={`0 0 ${MAP_W} ${MAP_H}`}>
          <G id="Group 1">
            ...
            <Rect id="rectangle_152" x={452} y={471} width={84} height={62} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="rectangle_153" x={452} y={413} width={84} height={55} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="rectangle_154" x={452} y={354} width={84} height={56} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="rectangle_155" x={452} y={295} width={84} height={56} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="rectangle_156" x={452} y={237} width={84} height={55} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="rectangle_157" x={452} y={178} width={84} height={56} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="rectangle_158" x={452} y={121} width={84} height={54} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="Anfiteatro-Física" x={428} y={3} width={108} height={115} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />

            <Rect id="rectangle_53" x={267} y={761} width={45} height={32} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="rectangle_56" x={267} y={796} width={45} height={50} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="rectangle_58" x={315} y={758} width={21} height={91} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />

            <Rect id="buffet" x={309} y={556} width={93} height={120} fill="#FEE2E2" stroke="#DC2626" strokeWidth={2} />
            <Rect id="sum" x={309} y={313} width={93} height={240} fill="#ECFDF5" stroke="#059669" strokeWidth={2} />
            <Rect id="baños_mixtos" x={332} y={702} width={63} height={23} fill="#FDE68A" stroke="#D97706" strokeWidth={1} />
            <Rect id="rectangle_39" x={286} y={702} width={43} height={23} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            <Rect id="rectangle_35" x={398} y={679} width={27} height={46} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
            ...
            <Rect id="rectangle_8" x={143} y={802} width={75} height={44} fill="#F9FAFB" stroke="#9CA3AF" strokeWidth={1} />
